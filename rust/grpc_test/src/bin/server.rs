extern crate grpc_test;
extern crate grpc;
extern crate protobuf;

use std::thread;
use grpc_test::foobar_grpc::*;
use grpc_test::foobar::*;
...
impl FooBarService for FooBarServer {
    ...
    fn get_cabs(&self, _m: grpc::RequestOptions, _req: GetCabRequest) -> grpc::SingleResponse<GetCabResponse> {
