...
export function digest(data) {
    const retptr = 8;
    const ret = wasm.digest(retptr, passStringToWasm(data), WASM_VECTOR_LEN);
...
*/
export function digest_attach(data, elem_id) {
    wasm.digest_attach(passStringToWasm(data), WASM_VECTOR_LEN, passStringToWasm(elem_id), WASM_VECTOR_LEN);
}
